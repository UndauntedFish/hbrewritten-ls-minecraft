package com.ben.hbrewrittenls.lobbytimer;

import com.ben.hbrewrittenls.Main;
import com.ben.hbrewrittenls.PlayerData;
import com.ben.hbrewrittenls.listeners.PluginMessage;
...
public class Timer
{
	...
	private void sendPlayersToGame()
	{
		...
		for (PlayerData pd : Main.getInstance().playerDataMap.values())
		{
			Player player = Bukkit.getPlayer(pd.getUUID());
			PluginMessage.connect(player, gameServer);
		}
	}
